...
//Stellar & VerififiedTokens on that chain
// Base & VerififiedTokens on that chain
// Ethereum & VerififiedTokens on that chain
...
VerifiedBlockchain ={
    ...
    [2. baseBlockchain ], ={
        ...
        chainId = 8453 ;
        chainRpcUrl1 = https://base-rpc.publicnode.com ;
        chainRpcUrl2 = https://base.meowrpc.com;
        chainRpcUrl3 =  wss://base.callstaticrpc.com ;
        chainRpcUrl4 =  https://base-pokt.nodies.app ;
        chainRpcUrl5 =  https://0xrpc.io/base;
        chainCurrency=  ETH ;
        returns Base Mainnet;

        baseVerifiedTokenAssets ={
/*
    USD Tether = [
            tokenAssetName = United States Dollar Tether;
            tokenAssetDecimal =  6;
